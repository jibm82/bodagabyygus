...
<body>
	...
	<div id="wrapper">
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="hero-wrapper v-center">
							<!-- <h2 data-animation-direction="fade" data-animation-delay="600">Nos casamos</h2> -->

							<h1 class="hero-title light ">
								<span data-animation-direction="from-right" data-animation-delay="300">Jaesy</span>
								<small data-animation-direction="from-top" data-animation-delay="300">&</small>
								<span data-animation-direction="from-left" data-animation-delay="300">Jorge</span>
							</h1>

							<div class="hero-subtitle light" data-animation-direction="fade" data-animation-delay="1000">NOV <span>19</span> 2022</div>
						...
						<div class="timeline">
							...
							<div class="gallery-container">
								<div class="timeline-gallery-wrapper" data-animation-direction="from-left" data-animation-delay="250">
									<div class="timeline-gallery owl-carousel">
										...
										<div class="item">
											<img src="./images/dress-code/women.jpg" alt="" />
										</div>
							...
							<div class="gallery-container">
								<div class="timeline-gallery-wrapper" data-animation-direction="from-left" data-animation-delay="250">
									<div class="timeline-gallery owl-carousel">
										<div class="item">
											<img src="./images/dress-code/men8.jpg" alt="" />
										</div>
		...
		<section id="giftregistry" class="section-bg-color parallax-background bg-color2-overlay2">
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-xl-6">
						<h2 class="section-title-lg uppercase desc"><small>Mesa de</small><strong>regalos</strong></h2>
					</div>
				</div>
					...
					<div class="col-lg-12 col-xl-10 offset-xl-1">
						<div id="testimonials-slider" class="owl-carousel testimonials light" data-animation-direction="from-bottom" data-animation-delay="300">
							<div class="item">
								...
								<p>
									Existen alojamientos para todos los presupuestos, todos los que ves aquí quedan cerca del centro histórico y del malecón (todo te quedará cerca)
								</p>
							</div>
						</div>
					</div>
		...
		<section id="blog" class="section-bg-color divider-bottom-2 divider-pattern divider-bg-color">
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						<h1 class="section-title">¿Qué hacer en Campeche?</h1>
					</div>
				</div>
							...
							<div class="row gx-5">
								...
								<article class="item col-md-4">
									...
									<div class="info-blog">
										<h3 class="post-title">
											<a target="_blank" href="https://alanxelmundo.com/5-lugares-instagrameables-en-campeche/">
												5 lugares instagrameables en Campeche
											</a>
										</h3>
                  </div>
								</article>
								...
								<article class="item col-md-4">
									...
									<div class="info-blog">
										<h3 class="post-title">
											<a target="_blank" href="https://www.unpinenelmapa.com/post/campeche-en-1-dia">
												20 cosas que ver y hacer en Campeche
											</a>
										</h3>
									</div>
								</article>
								...
								<article class="item col-md-4">
									...
									<div class="info-blog">
										<h3 class="post-title">
											<a target="_blank" href="https://www.unpinenelmapa.com/post/campeche-en-1-dia">
												Campeche en 1 día: 25 cosas que ver y hacer imprescindibles
											</a>
										</h3>
									</div>
								</article>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="footer-info left">
								Sábado, 19 de noviembre de 2022 a las 5:00 p.m.<br>
								Campeche, Campeche
							</div>
						</div>
