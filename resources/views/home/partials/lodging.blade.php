<section id="lodging" class="parallax-background bg-color-overlay">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
    ...
    <div class="container">
        <div class="my-2 row">
            <div class="col-lg-8 mx-auto fs-6">
                <div>
                    Existen alojamientos para todos los presupuestos, todos los que te señalamos
                    aquí quedan cerca del centro histórico y del malecón (la ciudad es pequeña así
                    que no te preocupes por las distancias).
                </div>
                <div class="mt-4">
                    Para trasladarte dentro de la ciudad, puedes hacerlo en taxi o caminando (no hay
                    servicio de plataformas como DIDI o UBER)
                </div>
            </div>
        </div>
        <ul class="mt-4">
            <li>
                ...
                <ul>
                    <li>
                        <a href="https://mayacampechehotel.com/" class="underlined" target="_blank">
                            Hotel Maya Campeche
                        </a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li>
                        <a href="https://www.oceanview.com.mx" target="_blank" class="underlined">
                            Hotel Ocean View
                        </a>
                    </li>
                    <li>
            ...
            <li>
                <div class="fw-bold mt-4">
                    Hoteles Boutique Entre $3,000 y $5,000 por noche
                </div>
                <ul>
                    <li>
